...
class TestAnalyzeIntent:
    ...
    async def test_invalid_intent_type_defaults_to_chat(self):
        ...
        response = json.dumps(
            {"type": "invalid_type", "task_list": [], "reasoning": "Something"}
        )
    ...
    async def test_task_list_not_a_list_defaults_to_empty(self):
        ...
        response = json.dumps(
            {"type": "task", "task_list": "not a list", "reasoning": "Something"}
        )
    ...
    async def test_missing_reasoning_defaults_to_empty(self):
        ...
        response = json.dumps({"type": "chat", "task_list": []})
    ...
    async def test_llm_receives_cwd_context(self):
        """Test that stream_response receives messages with cwd context."""
        response = json.dumps({"type": "chat", "task_list": [], "reasoning": "Test"})
        ...
        # Check that stream_response was called with messages containing the cwd
    ...
    @pytest.mark.asyncio
    async def test_non_dict_json_defaults_to_chat(self):
        """Test that non-dict JSON (e.g. list) defaults to chat."""
        response = json.dumps([{"type": "chat"}])
